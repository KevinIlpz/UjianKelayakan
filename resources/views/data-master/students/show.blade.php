...
<div class="p-2 grid items-center rounded-lg gap-3">
    ...
    <div class="text-right">
        ...
        <a href="{{ route('students.create') }}" class="text-white p-2 rounded-lg" style="background-color: #98FF98;">
            Tambah Data
        </a>
        @endif
    </div>
                            ...
                            @if (Auth::user()->role == "admin")
                                <td class="border-b border-gray-400 px-4 py-2 text-center">
                                    <div class="flex justify-center gap-2">
                                        <a href="{{ route('students.edit', $student->id) }}" class="rounded-lg p-2 text-white flex items-center" style="background-color: #98FF98;">
